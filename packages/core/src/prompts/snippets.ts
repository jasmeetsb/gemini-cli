...
${options.planModeToolsList}
  ...
  <tool>${formatToolName(options.activeEditToolName ?? EDIT_TOOL_NAME)} - Update plans in the plans directory</tool>
</available_tools>
